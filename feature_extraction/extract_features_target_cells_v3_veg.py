...
#default_features = ['std_norm_z', 'skew_norm_z', 'entropy_norm_z', 'perc_25_normalized_height', 'perc_50_normalized_height', 'perc_75_normalized_height', 'perc_95_normalized_height', 'band_ratio_normalized_height<1', 'band_ratio_1<normalized_height<2', 'band_ratio_2<normalized_height<3', 'band_ratio_3<normalized_height' ,'density_absolute_mean_norm_z']
#default_features = ['pulse_penetration_ratio','density_absolute_mean_norm_z']
default_features = ['mean_norm_z', 'std_norm_z', 'var_norm_z', 'kurto_norm_z', 'coeff_var_norm_z', 'band_ratio_normalized_height<1', 'band_ratio_1<normalized_height<2','band_ratio_2<normalized_height<3', 'band_ratio_3<normalized_height<4', 'band_ratio_4<normalized_height<5', 'band_ratio_5<normalized_height<6', 'band_ratio_6<normalized_height']
...
from laserchicken.feature_extractor import compute_features, list_feature_names, register_new_feature_extractor
from laserchicken.feature_extractor.feature_map import _create_name_extractor_pairs, create_default_feature_map
...
register_new_feature_extractor(BandRatioFeatureExtractor(3,4,data_key=keys.normalized_height))
register_new_feature_extractor(BandRatioFeatureExtractor(4,5,data_key=keys.normalized_height))
register_new_feature_extractor(BandRatioFeatureExtractor(5,6,data_key=keys.normalized_height))
register_new_feature_extractor(BandRatioFeatureExtractor(6,None,data_key=keys.normalized_height))
